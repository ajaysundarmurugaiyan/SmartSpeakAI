...
import { Mail, Lock, User as UserIcon, Chrome, Mic } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 text-sm">Start your English learning journey</p>
          {refCode && (
            <div className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-amber-700 bg-amber-50 border border-amber-200 px-3 py-1.5 rounded-full">
              🎁 You were invited! Enjoy your free trial.
            </div>
          )}
        </div>
