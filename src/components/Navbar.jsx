        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            {isPremium ? (
              ...
              <span className="hidden sm:inline-flex items-center gap-1 text-xs font-semibold text-amber-700 bg-amber-50 border border-amber-200 px-2 py-1 rounded-full">
                Trial · {daysLeftInTrial}d
              </span>
            ) : (
              <Link
                to="/pricing"
                className="hidden sm:inline-flex items-center gap-1 text-xs font-semibold text-white bg-gray-900 px-2.5 py-1 rounded-full hover:bg-gray-800 transition-colors"
              >
